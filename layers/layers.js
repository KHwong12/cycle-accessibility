...
var format_iB5000RoadPoly_1 = new ol.format.GeoJSON();
var features_iB5000RoadPoly_1 = format_iB5000RoadPoly_1.readFeatures(json_iB5000RoadPoly_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_iB5000RoadPoly_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_iB5000RoadPoly_1.addFeatures(features_iB5000RoadPoly_1);
var lyr_iB5000RoadPoly_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_iB5000RoadPoly_1, 
                style: style_iB5000RoadPoly_1,
                popuplayertitle: 'iB5000 — RoadPoly',
                interactive: false,
                title: '<img src="styles/legend/iB5000RoadPoly_1.png" /> iB5000 — RoadPoly'
            });
...
var format_cycletrackaccessibilitymhe_21c_4 = new ol.format.GeoJSON();
var features_cycletrackaccessibilitymhe_21c_4 = format_cycletrackaccessibilitymhe_21c_4.readFeatures(json_cycletrackaccessibilitymhe_21c_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_cycletrackaccessibilitymhe_21c_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_cycletrackaccessibilitymhe_21c_4.addFeatures(features_cycletrackaccessibilitymhe_21c_4);
var lyr_cycletrackaccessibilitymhe_21c_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_cycletrackaccessibilitymhe_21c_4, 
                style: style_cycletrackaccessibilitymhe_21c_4,
                popuplayertitle: 'cycle-track-accessibility — mhe_21c',
                interactive: true,
                title: '<img src="styles/legend/cycletrackaccessibilitymhe_21c_4.png" /> cycle-track-accessibility — mhe_21c'
            });
var format_Buffered100m_5 = new ol.format.GeoJSON();
var features_Buffered100m_5 = format_Buffered100m_5.readFeatures(json_Buffered100m_5, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Buffered100m_5 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Buffered100m_5.addFeatures(features_Buffered100m_5);
var lyr_Buffered100m_5 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Buffered100m_5, 
                style: style_Buffered100m_5,
                popuplayertitle: 'Buffered-100m',
                interactive: false,
                title: '<img src="styles/legend/Buffered100m_5.png" /> Buffered-100m'
            });
var format_Buffered200m_6 = new ol.format.GeoJSON();
var features_Buffered200m_6 = format_Buffered200m_6.readFeatures(json_Buffered200m_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Buffered200m_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Buffered200m_6.addFeatures(features_Buffered200m_6);
var lyr_Buffered200m_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Buffered200m_6, 
                style: style_Buffered200m_6,
                popuplayertitle: 'Buffered-200m',
                interactive: false,
                title: '<img src="styles/legend/Buffered200m_6.png" /> Buffered-200m'
            });
var format_CycFaciCYCPARKSPACE_7 = new ol.format.GeoJSON();
var features_CycFaciCYCPARKSPACE_7 = format_CycFaciCYCPARKSPACE_7.readFeatures(json_CycFaciCYCPARKSPACE_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_CycFaciCYCPARKSPACE_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_CycFaciCYCPARKSPACE_7.addFeatures(features_CycFaciCYCPARKSPACE_7);
var lyr_CycFaciCYCPARKSPACE_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_CycFaciCYCPARKSPACE_7, 
                style: style_CycFaciCYCPARKSPACE_7,
                popuplayertitle: 'CycFaci — CYCPARKSPACE',
                interactive: true,
                title: '<img src="styles/legend/CycFaciCYCPARKSPACE_7.png" /> CycFaci — CYCPARKSPACE'
            });

lyr_LandsDTopographicMap_0.setVisible(false);lyr_iB5000RoadPoly_1.setVisible(true);lyr_CycFaciCYCRAMP_2.setVisible(true);lyr_CycFaciCYCTRACK_3.setVisible(true);lyr_cycletrackaccessibilitymhe_21c_4.setVisible(true);lyr_Buffered100m_5.setVisible(true);lyr_Buffered200m_6.setVisible(true);lyr_CycFaciCYCPARKSPACE_7.setVisible(true);
var layersList = [lyr_LandsDTopographicMap_0,lyr_iB5000RoadPoly_1,lyr_CycFaciCYCRAMP_2,lyr_CycFaciCYCTRACK_3,lyr_cycletrackaccessibilitymhe_21c_4,lyr_Buffered100m_5,lyr_Buffered200m_6,lyr_CycFaciCYCPARKSPACE_7];
lyr_iB5000RoadPoly_1.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'LASTUPDATEDATE': 'LASTUPDATEDATE', 'FEATURE_ID': 'FEATURE_ID', 'FEATURESUBTYPE': 'FEATURESUBTYPE', 'FEATURECODE': 'FEATURECODE', 'DATASTATUS': 'DATASTATUS', 'DATASOURCE': 'DATASOURCE', 'DATALEVEL': 'DATALEVEL', 'ST_CODE': 'ST_CODE', 'EASTING': 'EASTING', 'NORTHING': 'NORTHING', 'ENGLISHNAME': 'ENGLISHNAME', 'CHINESENAME': 'CHINESENAME', 'DISTRICT': 'DISTRICT', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', });
