...
var lyr_CycFaciCYCPARKSPACE_6 = new ol.layer.Vector({
        ...
        var lyr_LandsDTopographicMapLabeltc_7 = new ol.layer.Tile({
...
lyr_LandsDTopographicMap_0.setVisible(true);lyr_Majorhousingestates_1.setVisible(true);lyr_CycFaciCYCRAMP_2.setVisible(true);lyr_CycFaciCYCTRACK_3.setVisible(true);lyr_Buffered100m_4.setVisible(false);lyr_Buffered200m_5.setVisible(true);lyr_CycFaciCYCPARKSPACE_6.setVisible(true);lyr_LandsDTopographicMapLabeltc_7.setVisible(true);
var layersList = [lyr_LandsDTopographicMap_0,lyr_Majorhousingestates_1,lyr_CycFaciCYCRAMP_2,lyr_CycFaciCYCTRACK_3,lyr_Buffered100m_4,lyr_Buffered200m_5,lyr_CycFaciCYCPARKSPACE_6,lyr_LandsDTopographicMapLabeltc_7];
